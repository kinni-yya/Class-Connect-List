...
$select_archive_result = SelectArchiveNote($class_id);
...
<div class="note-box">
	...
	<div class="note-detail">
		...
		<div class="container d-flex justify-content-end">
			<button class="btn btn-outline-success" data-id="<?php echo $row['note_id']; ?>" onclick="RestoreTask(this)">Restore</button>
