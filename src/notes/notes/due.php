...
$select_due_result = SelectDueRecord($class_id);
	...
	<div class="row" onclick="DisplayNoteDetails(this)">
		...
		<div class="col-2 align-self-center">
			...
			<span class="note-due"><?php 
				...
				if($difference < 0 ){
					echo "<span class=\"note-due\" style=\"color: red;\">".abs($difference)." day\\s late</span>";
				}
				else if($difference == 0){
					echo "<span class=\"note-due\" style=\"color: orange;\">Today!</span>";
				}
				else if ($difference > 0) {
					echo "<span class=\"note-due\" style=\"color: green;\">$difference day\\s</span>";
				}
			 ?></span>
			<br>
			<!-- Date -->
