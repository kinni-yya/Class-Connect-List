    ...
    $(function() {
        ...
        calendar = new Calendar(document.getElementById('calendar'), {
            ...
            eventClick: function(info) {
                ...
                if (!!scheds[calendar_id]) {
                    ...
                    // Check if the event_id is null then this is a subjet schedule
                    if(scheds[calendar_id].event_id == null){
        ...
        $('#edit').click(function() {
            ...
            if (!!scheds[calendar_id]) {
                ...
                _form.find('[name="subject_id"]').val(scheds[calendar_id].subject_id).change();
