...
if((isset($_POST['event_id']) && !empty($_POST['event_id'])) && (isset($_POST['event_title']) && !empty($_POST['event_title']))){
    $event_process_message = UpdateClassCalendarEvent($_POST['event_id'], $_POST['event_title'], $_POST['description'], $_POST['start_datetime'], $_POST['end_datetime'], $_POST['event_type'], $_POST['class_id'], $subject_id, $conn);
}
// If event ID doesn't have a value to process is to INSERT
    ...
    $event_process_message = InsertClassCalendarEvent($_POST['event_title'], $_POST['description'], $_POST['start_datetime'], $_POST['end_datetime'], $_POST['event_type'], $_POST['class_id'], $subject_id, $conn);
}
